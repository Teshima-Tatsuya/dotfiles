...
5. Commit with the message, ending with the attribution lines the session specifies (correct model name; don't hard-code one). If the session gives none, end with:
